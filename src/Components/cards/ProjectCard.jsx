    ...
    <div className="project-slider ">
      <Slider {...settings}>
        {projects.map((project) => (
          <div
            className="project w-full h-auto md:w-80 md:h-96 flex justify-between bg-white shadow-md rounded-md p-3 space-x-4 mb-4"
            key={project.id}
          >
            ...
            <div className="project-text mt-2">
              ...
              <ul className="project-tags flex mt-3 space-x-2">
                {project.tags.map((tag, index) => (
                  <li
                    className="inline-block bg-gray-100 px-2 py-1 text-xs rounded-md"
                    key={index}
                  >
                    {tag}
                  </li>
