...
<section id="projects" className="bg-gray-100 py-10">
  ...
  <div className="flex items-center mb-4">
    ...
    <div className="h-1 w-24 my-2 bg-gray-400"></div>
  </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="flex justify-center mt-4 space-x-2">
          ...
          <a href="https://loan-prediction-app-group-1b.netlify.app/" className="text-blue-500 hover:text-blue-600">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="flex justify-center mt-4 space-x-2">
          ...
          <a href="https://instragram-demo-1.netlify.app/" className="text-blue-500 hover:text-blue-600">
            Live Demo <FiExternalLink />
          </a>
        </div>
      </div>
